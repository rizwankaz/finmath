...
const SWAP_QUERY = gql`
  {
    swaps(first: 100000, orderBy: timestamp, orderDirection: desc) {
      id
      amountUSD
      timestamp
      token0 {
  ...
  const chartOptions = {
    scales: {
      x: {
        ...
        min: sixHoursAgo, // Set minimum time to 6 hours ago
